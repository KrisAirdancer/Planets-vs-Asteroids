...
public class Sprite {
	...
	/**
	 * Checks if the sprite has made it to the left edge of the screen which indicates the end of the game.
	 * 
	 * @return true if a sprite has made it to the left edge of the screen, false otherwise.
	 */
